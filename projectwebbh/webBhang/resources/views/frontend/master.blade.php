...
<body>    
		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a class="title" href="{{url('/')}}"><h1>ĐỒ ĐIỆN TỬ</h1></a>						
				...
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					<a class="display" href="{{url('cart/cartadd')}}">Giỏ hàng</a>
					<a href="{{url('cart/cartadd')}}">{{$items->count()}}</a>	
  ...
  color:black;
" href="{{url('admin/home/userhome')}}">Admin</a>	
					</h4>
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item"><a href="{{url('category/'.$ca->ca_id.'/'.$ca->ca_slug.'.html')}}" title="">{{$ca->ca_name}}</a></li>
			                @endforeach
						</ul>
				...
				<div id="main" class="col-md-9">
					...
					<div id="slider">
						<div id="demo" class="carousel slide" data-ride="carousel">
							...
							<a class="carousel-control-prev" href="{{url('/')}}" data-slide="prev">
								<span class="carousel-control-prev-icon"></span>
							</a>
							<a class="carousel-control-next" href="{{url('/')}}" data-slide="next">
