			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form method="post" enctype="multipart/form-data" action="{{url('admin/home/product/add')}}">
							<div class="row" style="margin-bottom:40px">
                               ...
                               <input type="file" name="img" class="form-control">
									...
									<div class="form-group" >
										...
										<input required type="text" name="waranty" class="form-control">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<select required name="cate" class="form-control">
                                            @foreach($data as $ct)
											<option value="{{ $ct->ca_id }}">{{ $ct->ca_name }}</option>
									...
									<a href="{{url('admin/home/product/dmproduct')}}" class="btn btn-danger">Hủy bỏ</a>
								</div>
							</div>
							{{csrf_field()}}
						</form>
